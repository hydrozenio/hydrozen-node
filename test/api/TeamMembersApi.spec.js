...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrozenApi.TeamMembersApi();
  });
  ...
  describe('TeamMembersApi', function() {
    ...
    describe('getTeamMembersByTeam', function() {
      it('should call getTeamMembersByTeam successfully', function(done) {
        //uncomment below and update the code to test getTeamMembersByTeam
        //instance.getTeamMembersByTeam(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
