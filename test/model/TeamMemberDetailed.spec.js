...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrozenApi.TeamMemberDetailed();
  });
  ...
  describe('TeamMemberDetailed', function() {
    it('should create an instance of TeamMemberDetailed', function() {
      // uncomment below and update the code to test TeamMemberDetailed
      //var instance = new HydrozenApi.TeamMemberDetailed();
      //expect(instance).to.be.a(HydrozenApi.TeamMemberDetailed);
    });
