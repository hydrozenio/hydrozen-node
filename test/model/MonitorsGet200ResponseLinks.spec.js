...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrozenApi.MonitorsGet200ResponseLinks();
  });
  ...
  describe('MonitorsGet200ResponseLinks', function() {
    it('should create an instance of MonitorsGet200ResponseLinks', function() {
      // uncomment below and update the code to test MonitorsGet200ResponseLinks
      //var instance = new HydrozenApi.MonitorsGet200ResponseLinks();
      //expect(instance).to.be.a(HydrozenApi.MonitorsGet200ResponseLinks);
    });
