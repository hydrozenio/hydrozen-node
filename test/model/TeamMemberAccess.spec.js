...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydrozenApi.TeamMemberAccess();
  });
  ...
  describe('TeamMemberAccess', function() {
    it('should create an instance of TeamMemberAccess', function() {
      // uncomment below and update the code to test TeamMemberAccess
      //var instance = new HydrozenApi.TeamMemberAccess();
      //expect(instance).to.be.a(HydrozenApi.TeamMemberAccess);
    });
